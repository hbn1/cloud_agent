...
def setup_graphrag():
    ...
    try:
        ...
        print("[OK] Neo4j 连接成功！图谱 Schema 已加载。")
    except Exception as e:
        print(f"[ERROR] Neo4j 连接失败，请检查数据库状态和配置: {e}")
        sys.exit(1)

    print("[Memory] 正在初始化 Qwen 大模型...")
    llm = ChatOpenAI(
