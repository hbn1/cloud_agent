...
"""
        ...
        if "finops" in decision:
            ...
            print("[Tool] [Orchestrator] 识别到营销推广意图，路由至: promotion_agent")
        elif "recommendation" in decision:
            next_node = "recommendation_agent"
            print("[Tool] [Orchestrator] 识别到选型推荐意图，路由至: recommendation_agent")
        else:
            next_node = "product_agent"
            print("[Tool] [Orchestrator] 默认或识别到产品咨询意图，路由至: product_agent")
